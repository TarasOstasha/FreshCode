...
// тут я обєднав ці 2 пункти вище сказані
// по кліку на кнопку генеруються цікаві факти про котів а також підтягуються рандомні фотки котів з цього api - https://cataas.com
loadData();
